...
// Gossip Item Text
#define GOSSIP_TEXT_BROWSE_GOODS        "Quisiera ver tu mercancía."
#define GOSSIP_TEXT_TRAIN               "¡Entréname!"

#define GOSSIP_TEXT_BANK                "El Banco"
#define GOSSIP_TEXT_WINDRIDER           "Maestro de Jinetes del Viento"
#define GOSSIP_TEXT_GRYPHON             "El Maestro de Grifos"
#define GOSSIP_TEXT_BATHANDLER          "Cuidador de Murciélagos"
#define GOSSIP_TEXT_HIPPOGRYPH          "El Maestro de Hipogrifos"
#define GOSSIP_TEXT_FLIGHTMASTER        "Maestro de Vuelo"
#define GOSSIP_TEXT_AUCTIONHOUSE        "Casa de Subastas"
#define GOSSIP_TEXT_GUILDMASTER         "Maestro de Hermandad"
#define GOSSIP_TEXT_INN                 "La Posada"
#define GOSSIP_TEXT_MAILBOX             "Buzón"
#define GOSSIP_TEXT_STABLEMASTER        "Maestro de Establos"
#define GOSSIP_TEXT_WEAPONMASTER        "Instructor de Armas"
#define GOSSIP_TEXT_BATTLEMASTER        "Maestro de Batalla"
#define GOSSIP_TEXT_CLASSTRAINER        "Instructor de Clase"
#define GOSSIP_TEXT_PROFTRAINER         "Instructor de Profesión"
#define GOSSIP_TEXT_OFFICERS            "El Salón de los Oficiales"

#define GOSSIP_TEXT_ALTERACVALLEY       "Valle Alterac"
...
#define GOSSIP_TEXT_EYEOFTHESTORM       "Ojo de la Tormenta"

#define GOSSIP_TEXT_DRUID               "Druida" 
#define GOSSIP_TEXT_HUNTER              "Cazador"
#define GOSSIP_TEXT_PRIEST              "Sacerdote"
#define GOSSIP_TEXT_ROGUE               "Pícaro"
#define GOSSIP_TEXT_WARRIOR             "Guerrero"
#define GOSSIP_TEXT_PALADIN             "Paladin"
#define GOSSIP_TEXT_SHAMAN              "Chamán"
#define GOSSIP_TEXT_MAGE                "Mago"
#define GOSSIP_TEXT_WARLOCK             "Brujo"

#define GOSSIP_TEXT_ALCHEMY             "Alquimia"
#define GOSSIP_TEXT_BLACKSMITHING       "Herrería"
#define GOSSIP_TEXT_COOKING             "Cocina"
#define GOSSIP_TEXT_ENCHANTING          "Encantamiento"
#define GOSSIP_TEXT_ENGINEERING         "Ingeniería"
#define GOSSIP_TEXT_FIRSTAID            "Primeros Auxilios"
#define GOSSIP_TEXT_HERBALISM           "Herboristería"
#define GOSSIP_TEXT_LEATHERWORKING      "Peletería"
#define GOSSIP_TEXT_POISONS             "Venenos"
#define GOSSIP_TEXT_TAILORING           "Sastrería"
#define GOSSIP_TEXT_MINING              "Minería"
#define GOSSIP_TEXT_FISHING             "Pesca"
#define GOSSIP_TEXT_SKINNING            "Desuello"
#define GOSSIP_TEXT_JEWELCRAFTING       "Joyería"

#define GOSSIP_TEXT_IRONFORGE_BANK      "Banco de Forjaz"
#define GOSSIP_TEXT_STORMWIND_BANK      "Banco de Ventormenta"
#define GOSSIP_TEXT_DEEPRUNTRAM         "Tranvía Subterráneo"
#define GOSSIP_TEXT_ZEPPLINMASTER       "Maestro de Zepelines"
